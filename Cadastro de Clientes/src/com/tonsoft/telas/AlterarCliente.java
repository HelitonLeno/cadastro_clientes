...
public class AlterarCliente extends JDialog {
    private TableModel tableModel = CadastroPrincipal.getInstanceModel();
    ...
    public AlterarCliente(Frame owner, boolean modal) {
        super(owner, modal);
        initComponents();
    }
    ...
    //---- Acao botao cancelar janela ----
    private void btnCancelarActionPerformed(ActionEvent e) {
        dispose();
    }

    //---- Salvar alteracoes cliente ----
    private void btnSalvarActionPerformed(ActionEvent e) {
        if ( txtNome.getText().equals(" ") || txtCelular.getText().equals("(  )       -    ") ||
            ...
            Cliente cliente = new Cliente(txtNome.getText(), txtCelular.getText(), txtEmail.getText(),
                    txtCidade.getText(), txtCpf.getText(), txtRg.getText(), txtIdade.getText(), txtTelefone.getText(),
                    txtRua.getText(), txtBairro.getText(), txtComp.getText(), txtNumero.getText(),
                    cbEstado.getSelectedItem().toString());

            tableModel.setValueAt(cliente, CadastroPrincipal.getSelectedRow(), 0);
            tableModel.atualizarId();
            dispose();
        }
    }

    // ---- Liberar usuario editar cliente ----
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            panel1.add(label7);
            label7.setBounds(new Rectangle(new Point(500, 35), label7.getPreferredSize()));

            //---- label8 ----
            label8.setText("* RG: ");
            label8.setForeground(Color.black);
            panel1.add(label8);
            label8.setBounds(new Rectangle(new Point(500, 75), label8.getPreferredSize()));
            ...
            try {
                ...
                txtNome.setValue(tableModel.getCliente(CadastroPrincipal.getSelectedRow()).getNome());
            ...
            try {
                ...
                mascaraIdade.setPlaceholderCharacter(' ');
                mascaraIdade.setValidCharacters("0123456789");
                mascaraIdade.install(txtIdade);
                txtIdade.setValue(tableModel.getCliente(CadastroPrincipal.getSelectedRow()).getDataNasc());
            } catch (ParseException e) {
                e.printStackTrace();
            }
            ...
            panel1.add(txtIdade);
            txtIdade.setBounds(235, 58, 100, txtIdade.getPreferredSize().height);
            ...
            try {
                ...
                txtCpf.setValue(tableModel.getCliente(CadastroPrincipal.getSelectedRow()).getCpf());
            } catch (ParseException e) {
                e.printStackTrace();
            }
            ...
            try {
                ...
                txtRg.setValue(tableModel.getCliente(CadastroPrincipal.getSelectedRow()).getRg());
            } catch (ParseException e) {
                e.printStackTrace();
            }
            ...
            panel1.add(rbM);
            rbM.setBounds(new Rectangle(new Point(220, 100), rbM.getPreferredSize()));
            ...
            panel1.add(rbF);
            rbF.setBounds(new Rectangle(new Point(275, 100), rbF.getPreferredSize()));
        }
        ...
        //======== panel2 ========
        {
            ...
            try {
                ...
                txtTelefone.setValue(tableModel.getCliente(CadastroPrincipal.getSelectedRow()).getTelefone());
            } catch (ParseException e) {
                e.printStackTrace();
            }
            ...
            txtEmail.setText(tableModel.getCliente(CadastroPrincipal.getSelectedRow()).getEmail());
            ...
            try {
                ...
                txtCelular.setValue(tableModel.getCliente(CadastroPrincipal.getSelectedRow()).getCelular());
            } catch (ParseException e) {
                e.printStackTrace();
            }
        ...
        //======== panel3 ========
        {
            ...
            panel3.add(label14);
            label14.setBounds(new Rectangle(new Point(500, 35), label14.getPreferredSize()));

            //---- label15 ----
            label15.setText("* Cidade: ");
            label15.setForeground(Color.black);
            panel3.add(label15);
            label15.setBounds(450, 70, 55, label15.getPreferredSize().height);
            ...
            txtRua.setText(tableModel.getCliente(CadastroPrincipal.getSelectedRow()).getRua());
            ...
            txtBairro.setText(tableModel.getCliente(CadastroPrincipal.getSelectedRow()).getBairro());
            txtBairro.setEnabled(false);
            txtBairro.setForeground(Color.black);
            panel3.add(txtBairro);
            txtBairro.setBounds(210, 70, 150, txtBairro.getPreferredSize().height);

            //---- txtComp ----
            txtComp.setBackground(Color.white);
            txtComp.setText(tableModel.getCliente(CadastroPrincipal.getSelectedRow()).getComp());
            ...
            try {
                ...
                txtNumero.setValue(tableModel.getCliente(CadastroPrincipal.getSelectedRow()).getNumero());
            } catch (ParseException e) {
                e.printStackTrace();
            }
            ...
            txtNumero.setBounds(559, 30, 80, txtNumero.getPreferredSize().height);

            //---- txtCidade ----
            txtCidade.setBackground(Color.white);
            txtCidade.setText(tableModel.getCliente(CadastroPrincipal.getSelectedRow()).getCidade());
            ...
            cbEstado.setSelectedItem(tableModel.getCliente(CadastroPrincipal.getSelectedRow()).getUf().toString());
            panel3.add(cbEstado);
        ...
        //======== panel4 ========
        {
            ...
            btnSalvar.setBounds(100, 5, 100, btnSalvar.getPreferredSize().height);
            ...
            btnCancelar.setBounds(500, 5, 100, btnCancelar.getPreferredSize().height);

            //---- btnEditar ----
            btnEditar.setText("Editar");
            btnEditar.addActionListener(e -> btnEditarActionPerformed(e));
            panel4.add(btnEditar);
            btnEditar.setBounds(300, 5, 100, btnEditar.getPreferredSize().height);
        }
